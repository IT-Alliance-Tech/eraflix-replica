...
import decorationsImg from '@/assets/decorations-setup-service.png';
import cakeImg from '@/assets/cake-arrangement-catering.png';
import photographyImg from '@/assets/photography-av-media-service.png';
import teddyImg from '@/assets/teddy-guest-amenities.png';
import bouquetImg from '@/assets/bouquet-premium-add-on.png';
import chocolateImg from '@/assets/chocolate-box-refreshments.png';
                      ...
                      <Stack spacing={3} sx={{ height: "100%" }}>
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <YouTube sx={{ color: "#2563EB", mb: 0.5 }} />
                              <Typography
                                variant="body2"
                                fontWeight="bold"
                                color="error.main"
          ...
          <Stack spacing={4}>
            ...
            <Card>
              <CardContent>
                ...
                >
                  Enhance your booking with our professional services
                </Typography>
                  ...
                  {[
                    {
                      ...
                      desc: "Professional workspace arrangement and seating setup",
                      img: decorationsImg.src,
                    },
                    {
                      key: "cake",
                      title: "Catering Services",
                      desc: "Refreshments including coffee, snacks, and beverages",
                      img: cakeImg.src,
                    },
                    {
                      key: "photography",
                      title: "AV & Media Support",
                      desc: "Recording equipment and presentation media setup",
                      img: photographyImg.src,
                    },
                    {
                      key: "teddy",
                      title: "Guest Amenities",
                      desc: "Welcome kits and basic amenities for attendees",
                      img: teddyImg.src,
                    },
                    {
                      key: "chocolate",
                      title: "Refreshments",
                      desc: "Light snacks and beverage service during session",
                      img: chocolateImg.src,
                    },
                    {
                      key: "bouquet",
                      title: "Premium Add-ons",
                      desc: "Enhanced comfort features and premium amenities",
                      img: bouquetImg.src,
                    },
                  ].map((item) => (
                    <Card
                ...
                <Box sx={{ mt: 3 }}>
                  <TextField
                    ...
                    placeholder="Any special requirements, dietary preferences, accessibility needs, or specific setup instructions..."
                    helperText="Let us know how we can better accommodate your booking"
                  />
                </Box>
              </CardContent>
            </Card>
