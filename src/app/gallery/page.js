        ...
        {images.length === 0 ? (
          <Box sx={{ 
            ...
            <Typography variant="body1" color="text.secondary" sx={{ maxWidth: 400 }}>
              {"We're adding beautiful photos of our premium space experiences. Check back soon to see amazing moments from DemoBooking!"}
            </Typography>
          </Box>
        ) : (
          <Box sx={{ width: '100%' }}>
            ...
            <Box>
              ...
              <Box sx={{ p: 3 }}>
                {/* <Typography variant="h5" gutterBottom sx={{ 
                  ...
                  {selectedImage.title || 'DemoBooking Experience'}
                </Typography> */}
