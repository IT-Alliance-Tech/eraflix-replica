...
import contactBG from '@/assets/contact-us-replica.png';
    ...
    <Box sx={{
      ...
      >
        ...
        >
          ...
          >
            Get in <Box component="span" color="#6366F1">Touch</Box>
          </Typography>
          ...
          <Box sx={{ display: "flex", gap: 3, mt: 4, flexWrap: 'wrap' }}>
            ...
            <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
              ...
              <Typography variant="body2" sx={{ color: "#fff" }}>demo@bookingplatform.com</Typography>
            </Box>
          </Box>
        </Box>
        ...
        <Box sx={{ flex:1, position:"relative", display:"flex", justifyContent:"center", alignItems:"center", backgroundColor:"#f5f5f5" }}>
          <Image src={contactBG} alt="Contact" style={{ width:"100%", height:"100%", objectFit:"fit", borderLeft: "5px solid #2563EB" }}/>
        </Box>
      </Box>
