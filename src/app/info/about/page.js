...
export default function AboutPage() {
  ...
  const features = [
    {
      icon: <Star size={40} />,
      title: "Premium Private Spaces",
      description: "State-of-the-art facilities and amenities for the ultimate experience"
    },
    {
      icon: <Calendar size={40} />,
      title: "Special Occasion Celebrations",
      description: "Birthdays, anniversaries, meetings, and more with custom arrangements"
    },
    {
      icon: <Users size={40} />,
    ...
    >
      <Container maxWidth="lg">
        ...
        <Typography 
          ...
          >
            Creating unforgettable memories through premium private space experiences
          </Typography>
          </Box>  
        </Box>
    ...
    >
      ...
      <Box sx={{ flex: 2 }}>
        <Box textAlign="center" mb={4}>
          ...
          >
           {"Premier Private Space Destination"}
          </Typography>
          <Box
            sx={{
              width: 80,
        ...
        <Stack spacing={3} maxWidth="800px" mx="auto">
          ...
          >
           {"DemoBooking is your trusted booking platform, offering a unique way to celebrate life's special moments with best-in-class private space experiences where customers can enjoy birthdays, anniversaries, meetings, or just relaxing time, complete with quality service and full privacy to make every event extraordinary."}
          </Typography>
        </Stack>
      </Box>
    </Paper>
 ...
 mb: 4 }}
    ...
    >
      ...
      <Box sx={{ flex: 1 }}>
        ...
        >
          <Star size={48} color="#2563EB" style={{ marginBottom: 16 }} />
...
>
      ...
      <Box sx={{ flex: 1 }}>
        ...
        >
          <Eye size={48} color="#2563EB" style={{ marginBottom: 16 }} />
          <Typography variant="h4"  gutterBottom    sx={{  fontSize: { xs: '2rem', md: '3rem', lg:'48px' }, fontStyle :'italic', 
              fontFamily: '"Cormorant", serif', fontWeight:400,
            }}
>
          ...
          <Typography variant="h6" color="text.secondary" sx={{ lineHeight: 1.6 }}>
            To become the leading booking platform, delivering unforgettable experiences while continuously innovating to exceed customer expectations.
          </Typography>
        </Paper>
      </Box>
    </Box>
