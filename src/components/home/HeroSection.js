    ...
    <Box
      sx={{
        ...
        '&::before': {
          ...
          right: 0,
          bottom: 0,
          background: 'linear-gradient(rgba(15, 23, 42, 0.55), rgba(15, 23, 42, 0.25))',
          zIndex: 0
        }
      }}
    >
      <Container sx={{ maxWidth: '1200px', position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          <Box component="span" sx={{ background: 'linear-gradient(45deg, #2563EB, #6366F1)', backgroundClip: 'text', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
            In Action
          </Box>
        </Typography>
          ...
          <Grid container spacing={{ xs: 3, sm: 4, md: 6, lg: 9 }} alignItems="center" sx={{ width: '100%' }}>
            ...
            <Grid item xs={12} lg={6}>
              <Box sx={{ textAlign: { xs: 'center', lg: 'left' }, px: { xs: 2, sm: 0 } }}>
                ...
                >
                 {`Experience a complete booking flow for space reservations and scheduling.
                 This demo platform showcases meeting rooms, workspaces, and flexible booking options — explore the full workflow.`}
                ...
                <Stack direction={{ xs: 'column', sm: 'row' }} spacing={{ xs: 2, sm: 3 }} sx={{ mb: { xs: 4, sm: 5, lg: 7 }, alignItems: 'center', justifyContent: { xs: 'center', lg: 'flex-start' } }}>
                  <Button
                    ...
                    sx={{ borderRadius: 50, py: { xs: 1.5, sm: 2 }, px: { xs: 3, sm: 4 }, fontSize: { xs: '1rem', sm: '1.1rem' }, fontWeight: 'bold', background: 'linear-gradient(45deg, #2563EB, #1E40AF)', boxShadow: '0 8px 32px rgba(37, 99, 235, 0.4)', minWidth: { xs: 200, sm: 'auto' }, '&:hover': { background: 'linear-gradient(45deg, #1E40AF, #1E3A8A)', transform: 'translateY(-3px)', boxShadow: '0 12px 40px rgba(37, 99, 235, 0.6)' }, transition: 'all 0.3s ease' }}
                  >
                    Try Demo Booking
                  </Button>
                  <Button variant="outlined" size="large" startIcon={<PhoneIcon />} href="tel:+15550109999" sx={{ borderRadius: 50, py: { xs: 1.5, sm: 2 }, px: { xs: 3, sm: 4 }, fontSize: { xs: '1rem', sm: '1.1rem' }, fontWeight: 'bold', borderColor: 'white', color: 'white', borderWidth: 2, minWidth: { xs: 200, sm: 'auto' }, '&:hover': { borderColor: 'white', bgcolor: 'rgba(255,255,255,0.1)', transform: 'translateY(-3px)', borderWidth: 2 }, transition: 'all 0.3s ease' }}>
                    Contact Sales
                  </Button>
                </Stack>
